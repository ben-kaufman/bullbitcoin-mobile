        ...
        appBar: AppBar(
          ...
          flexibleSpace: TopBar(
            ...
            action: state.isSigningSession
                ? TextButton(
                    onPressed: state.persistingPendingTransaction
                        ? null
                        : () => context.pop(),
                    child: BBText(
            ...
            child: Column(
              ...
              children: [
                BBButton.big(
                  ...
                  disabled: state.persistingPendingTransaction,
...
Future<void> _handleSigningBack(BuildContext context) async {
  ...
  if (state.persistingPendingTransaction) return;
...
Future<void> _confirmRestartSigning(BuildContext context) async {
  if (context.read<SendCubit>().state.persistingPendingTransaction) return;
