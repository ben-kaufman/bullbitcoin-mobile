...
class SendLocator {
  ...
  static void registerUsecases(GetIt locator) {
    ...
    locator.registerFactory<VerifyBitcoinSignedTransactionUsecase>(
      () =>
          VerifyBitcoinSignedTransactionUsecase(locator<BitcoinSigningPort>()),
    );
    locator.registerFactory<ProcessBitcoinSignerResultUsecase>(
      () => ProcessBitcoinSignerResultUsecase(
        ...
        verifyBitcoinSignedTransactionUsecase:
            locator<VerifyBitcoinSignedTransactionUsecase>(),
      ),
    );
