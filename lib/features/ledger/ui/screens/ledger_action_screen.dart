...
class _LedgerActionViewState extends State<_LedgerActionView> {
  ...
  Future<void> _executeRegisterWalletPolicy(LedgerDeviceEntity device) {
    ...
    if (request is! RegisterLedgerWalletPolicyRequest) {
      throw LedgerError.operationFailed(
        message: 'LEDGER_ERROR_MISSING_WALLET_POLICY',
      );
    }
  ...
  String _getErrorMessage(BuildContext context, String? errorMessage) {
    ...
    switch (errorMessage) {
      ...
      case 'LEDGER_ERROR_UNSUPPORTED_WALLET_POLICY':
        return context.loc.hardwareWalletPolicyUnsupported;
      case 'LEDGER_ERROR_WALLET_POLICY_NOT_REGISTERED':
        return context.loc.hardwareWalletPolicyNotRegistered;
      case 'LEDGER_ERROR_ADDRESS_MISMATCH':
        return context.loc.hardwareWalletAddressMismatch;
      case 'LEDGER_ERROR_MISSING_WALLET_POLICY':
        return context.loc.ledgerErrorMissingWalletPolicy;
      default:
        return context.loc.ledgerErrorUnknown;
    }
  }
