  ...
  static final route = ShellRoute(
    builder: (context, state, child) {
      ...
      final request = extra is BroadcastSignedTxRequest
          ? extra
          : extra is ({String? unsignedPsbt, bool collectSignerResult})
          ? BroadcastSignedTxRequest(
              unsignedPsbt: extra.unsignedPsbt,
              collectSignerResult: extra.collectSignerResult,
            )
          : extra is String
          ? BroadcastSignedTxRequest(unsignedPsbt: extra)
